function [crab, crabInvisNode, crabBody] = getCrabs (size);
...
crabInvisNode = [0; 0; 1];
crabBody = [crabPt1, crabPt2, crabPt3, crabPt4];
crab = [crabPt1, crabPt2, crabPt3, crabPt4, crabPt5, crabPt6, crabPt7,...
 crabPt8, crabPt9, crabPt10, crabPt11, crabPt12];
